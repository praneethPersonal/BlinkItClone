...
import FeedingImg from "C:\\Users\\KopparapuPraneeth\\OneDrive - Integrate\\Documents\\BlinkIt Clone\\FrontEnd\\my-app\\src\\Components\\Photos\\feeding_india_icon_v6.jpg";
import TimePic from "C:\\Users\\KopparapuPraneeth\\OneDrive - Integrate\\Documents\\BlinkIt Clone\\FrontEnd\\my-app\\src\\Components\\Photos\\15-mins-filled.png";
import emoji1 from "C:\\Users\\KopparapuPraneeth\\OneDrive - Integrate\\Documents\\BlinkIt Clone\\FrontEnd\\my-app\\src\\Components\\Photos\\emojie1.jpg";
import emoji2 from "C:\\Users\\KopparapuPraneeth\\OneDrive - Integrate\\Documents\\BlinkIt Clone\\FrontEnd\\my-app\\src\\Components\\Photos\\emoji2.jpg";
import emoji3 from "C:\\Users\\KopparapuPraneeth\\OneDrive - Integrate\\Documents\\BlinkIt Clone\\FrontEnd\\my-app\\src\\Components\\Photos\\emoji3.png";
import emoji4 from "C:\\Users\\KopparapuPraneeth\\OneDrive - Integrate\\Documents\\BlinkIt Clone\\FrontEnd\\my-app\\src\\Components\\Photos\\emoji4.jpg";
...
export function CartSideBar({isCartOpen,setIsCartOpen,isLoggedIn, setShowLoginDialog,setIsLoggedIn}){
  ...
  const handleProceed = async () => {
    ...
    try {
      ...
      const validateResponse = await fetch('https://localhost:7081/api/BlinkIt/validateToken', {
          method: 'POST',
          headers: {
      ...
      if (validateResponse.ok) {
          ...
          const addProductsResponse = await fetch('https://localhost:7081/api/BlinkIt/user/addProducts', {
              method: 'POST',
              headers: {
                  'Content-Type': 'application/json',
                  'Authorization': `Bearer ${jwtToken}`
